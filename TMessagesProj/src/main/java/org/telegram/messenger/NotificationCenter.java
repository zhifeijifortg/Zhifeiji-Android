...
public class NotificationCenter {
    ...
    public static final int didReceiveNewMessages = totalEvents++;  //1
    public static final int updateInterfaces = totalEvents++;       //2
    public static final int dialogsNeedReload = totalEvents++;      //3
    ...
    public static final int changeRepliesCounter = totalEvents++;   //10
    ...
    public static final int messageReceivedByServer = totalEvents++;    //15
    ...
    public static final int chatDidCreated = totalEvents++;         //20
    ...
    public static final int mediaCountDidLoad = totalEvents++;      //25
    ...
    public static final int dialogPhotosLoaded = totalEvents++;     //30
    ...
    public static final int blockedUsersDidLoad = totalEvents++;    //35
    ...
    public static final int updateMessageMedia = totalEvents++;     //40
    ...
    public static final int didRemoveTwoStepPassword = totalEvents++;   //45
    ...
    public static final int didReceivedWebpagesInUpdates = totalEvents++;   //50
    ...
    public static final int messagesReadContent = totalEvents++;    //55
    ...
    public static final int chatSearchResultsAvailable = totalEvents++; //60
    ...
    public static final int needShowPlayServicesAlert = totalEvents++;  //65
    ...
    public static final int reloadHints = totalEvents++;        //70
    ...
    public static final int archivedStickersCountDidLoad = totalEvents++;   //75
    ...
    public static final int didUpdatePollResults = totalEvents++;   //80
    ...
    public static final int startAllHeavyOperations = totalEvents++;    //85
