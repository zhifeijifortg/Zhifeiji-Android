...
public class IntroActivity extends BaseActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EventUtil.post(mActivity, EventUtil.Even.欢迎页展示, new HashMap<>());
        ...
        startMessagingButton.setOnClickListener(view -> {
            ...
            EventUtil.post(mActivity, EventUtil.Even.欢迎页开始按钮点击, new HashMap<>());
            startPressed = true;
