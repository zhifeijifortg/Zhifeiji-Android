...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public int getItemCount() {
        List<TLRPC.Dialog> array = DialogsActivity.getDialogsArray(currentAccount, dialogsType, folderId, dialogsListFrozen);
    ...
    public TLObject getItem(int i) {
        ...
        List<TLRPC.Dialog> arrayList = DialogsActivity.getDialogsArray(currentAccount, dialogsType, folderId, dialogsListFrozen);
        if (hasHints) {
    ...
    public void notifyItemMoved(int fromPosition, int toPosition) {
        List<TLRPC.Dialog> dialogs = DialogsActivity.getDialogsArray(currentAccount, dialogsType, folderId, false);
