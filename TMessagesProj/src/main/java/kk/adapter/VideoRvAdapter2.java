 ...
 * 首页视频列表
 */
public class VideoRvAdapter2 extends BaseDelegateMultiAdapter<KKVideoMessage, BaseViewHolder> implements LoadMoreModule {
    Context context;
    ...
    private void initDelegate() {
        ...
        getMultiTypeDelegate()
                .addItemType(1, R.layout.view_video_item_style_l);
    }
    ...
    private void showItem(BaseViewHolder baseViewHolder, KKVideoMessage entity) {
        ...
        if (entity.getDocument() != null && entity.getDocument().thumbs != null) {
            ...
            ivThumb.setRoundRadius(AndroidUtilities.dp(5));
        ...
        //来自
        baseViewHolder.setText(R.id.tv_from, context.getResources().getString(R.string.video_from) + entity.getFromName());
